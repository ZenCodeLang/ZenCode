...
public class JavaMethodBytecodeCompiler implements JavaMethodCompiler<Void> {
	private static final JavaNativeMethod BOOLEAN_TO_STRING = JavaNativeMethod.getNativeStatic(JavaClass.BOOLEAN, "toString", "(Z)Ljava/long/String;", "(Z)Ljava/long/String;");
	...
	private static final JavaNativeMethod INTEGER_COMPARE_UNSIGNED = JavaNativeMethod.getNativeStatic(JavaClass.INTEGER, "compareUnsigned", "(II)I", "(II)I");
	...
	private static final JavaNativeMethod LONG_COMPARE = JavaNativeMethod.getNativeStatic(JavaClass.LONG, "compare", "(JJ)I", "(JJ)I");
	private static final JavaNativeMethod LONG_COMPARE_UNSIGNED = JavaNativeMethod.getNativeStatic(JavaClass.LONG, "compareUnsigned", "(JJ)I", "(JJ)I");
	...
	private static final JavaNativeMethod STRING_COMPARETO = JavaNativeMethod.getNativeVirtual(JavaClass.STRING, "compareTo", "(Ljava/lang/String;)I", "(Ljava/lang/String;)I");
	...
	private static final JavaNativeMethod STRING_LENGTH = JavaNativeMethod.getNativeVirtual(JavaClass.STRING, "length", "()I", "()I");
	private static final JavaNativeMethod STRING_CHARACTERS = JavaNativeMethod.getNativeVirtual(JavaClass.STRING, "toCharArray", "()[C", "()[C");
	...
	private static final JavaNativeMethod STRING_CONTAINS = JavaNativeMethod.getNativeVirtual(JavaClass.STRING, "contains", "(Ljava/lang/CharSequence;)Z", "(Ljava/lang/CharSequence;)Z");
	private static final JavaNativeMethod ENUM_COMPARETO = JavaNativeMethod.getNativeVirtual(JavaClass.ENUM, "compareTo", "(Ljava/lang/Enum;)I", "(Ljava/lang/Enum;)I");
	private static final JavaNativeMethod HASHMAP_INIT = JavaNativeMethod.getNativeConstructor(JavaClass.HASHMAP, "()V", "()V");
	private static final JavaNativeMethod MAP_GET = JavaNativeMethod.getInterface(JavaClass.MAP, "get", "(Ljava/lang/Object;)Ljava/lang/Object;", "(TK;)TV;");
	private static final JavaNativeMethod MAP_PUT = JavaNativeMethod.getInterface(JavaClass.MAP, "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "(TK;TV;;)TV;");
	private static final JavaNativeMethod MAP_PUT_ALL = JavaNativeMethod.getInterface(JavaClass.MAP, "putAll", "(Ljava/util/Map;)V", "(Ljava/util/Map<TK;TV;>;)V");
	private static final JavaNativeMethod MAP_CONTAINS_KEY = JavaNativeMethod.getInterface(JavaClass.MAP, "containsKey", "(Ljava/lang/Object;)Z", "(TK;)Z");
	...
	private static final JavaNativeMethod MAP_KEYS = JavaNativeMethod.getInterface(JavaClass.MAP, "keySet", "()Ljava/util/Set;", "()Ljava/util/Set<TK;>;");
	private static final JavaNativeMethod MAP_VALUES = JavaNativeMethod.getInterface(JavaClass.MAP, "values", "()Ljava/util/Set;", "()Ljava/util/Set<TV;>;");
	...
	private static final JavaNativeMethod COLLECTION_TOARRAY = JavaNativeMethod.getNativeVirtual(JavaClass.COLLECTION, "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", "([TT;)[TT;");

	private static final JavaNativeMethod OBJECTS_EQUALS = new JavaNativeMethod(JavaClass.fromInternalName("java/util/Objects", JavaClass.Kind.CLASS), JavaNativeMethod.Kind.STATIC, "equals", false, "(Ljava/lang/Object;Ljava/lang/Object;)Z", "(Ljava/lang/Object;Ljava/lang/Object;)Z", 0, false);

	private static final JavaNativeMethod STRINGBUILDER_LENGTH = JavaNativeMethod.getNativeVirtual(JavaClass.STRINGBUILDER, "length", "()I", "()I");
	...
	public Void builtinStaticMethod(BuiltinMethodSymbol method, CallArguments args) {
		...
		switch (method) {
			...
			case ENUM_VALUES: {
				...
				final String signatureAndDescriptor = "()[L" + cls.internalName + ";";
				javaWriter.invokeStatic(JavaNativeMethod.getNativeStatic(cls, "values", signatureAndDescriptor, signatureAndDescriptor));
				break;
			}
			case RANGE_FROM: {
	...
	public Void specialStaticMethod(JavaSpecialMethod method, CallArguments args) {
		...
		switch (method) {
			...
			case LIST_TO_ARRAY: {
				...
				final JavaNativeMethod toArray = new JavaNativeMethod(JavaClass.COLLECTION, JavaNativeMethod.Kind.INSTANCE, "toArray", true, "([Ljava/lang/Object;)[Ljava/lang/Object;", "([TT;)[TT;", 0, true);
			...
			case SORTED: {
				...
				final JavaNativeMethod sort = JavaNativeMethod.getNativeExpansion(JavaClass.ARRAYS, "sort", "([Ljava/lang/Object;)V", "([T;)V");
			...
			case SORTED_WITH_COMPARATOR: {
				...
				final JavaNativeMethod sortWithComparator = JavaNativeMethod.getNativeExpansion(JavaClass.ARRAYS, "sort", "([Ljava/lang/Object;Ljava/util/Comparator;)V", "([TT;Ljava/util/Comparator<TT;>;)V");
			...
			case ARRAY_COPY: {
				...
				final JavaNativeMethod clone = JavaNativeMethod.getNativeVirtual(JavaClass.OBJECT, "clone", "()Ljava/lang/Object;", "()Ljava/lang/Object;");
			...
			case ARRAY_COPY_RESIZE: {
				...
				final JavaNativeMethod copyOf = JavaNativeMethod.getNativeStatic(JavaClass.ARRAYS, "copyOf", methodDescriptor, methodDescriptor);
			...
			case ARRAY_COPY_TO: {
				...
				final JavaNativeMethod javaMethod = JavaNativeMethod.getStatic(system, "arraycopy", "(Ljava/lang/Object;ILjava/lang/Object;II)V", "(Ljava/lang/Object;ILjava/lang/Object;II)V", JavaModifiers.PUBLIC);
