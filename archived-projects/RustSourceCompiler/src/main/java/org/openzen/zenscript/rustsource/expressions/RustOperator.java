...
public enum RustOperator implements FormattableOperator {
	INCREMENT(14, "++"),
	DECREMENT(14, "--"),
	...
	private RustOperator(int priority, String operatorString) {
		this.priority = priority;
		this.operatorString = operatorString;
	}

	public static RustOperator getComparison(CompareType compare) {
		switch (compare) {
			case EQ:
				return EQUALS;
			case NE:
