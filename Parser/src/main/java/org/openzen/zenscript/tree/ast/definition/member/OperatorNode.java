...
public class OperatorNode extends DefinitionMemberNode {
	...
	public OperatorNode(CodePosition position, List<AnnotationNode> annotations, ModifiersNode modifiers, OperatorType operator, FunctionHeaderNode header, ASTNode body) {
