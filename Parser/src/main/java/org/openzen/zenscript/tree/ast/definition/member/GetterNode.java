...
public class GetterNode extends DefinitionMemberNode {
	...
	public GetterNode(CodePosition position, List<AnnotationNode> annotations, ModifiersNode modifiers, NameNode name, TypeNode type, ASTNode body) {
