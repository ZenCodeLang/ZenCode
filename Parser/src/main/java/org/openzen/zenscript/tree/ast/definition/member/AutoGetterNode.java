...
public class AutoGetterNode implements ASTNode {
	private final CodePosition position;
	private final ModifiersNode modifiers;

	public AutoGetterNode(CodePosition position, ModifiersNode modifiers) {
	...
	public <C, R> R accept(ASTVisitor<C, R> visitor, C context) {
		return visitor.visitAutoGetter(this, context);
	}
