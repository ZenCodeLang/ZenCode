...
public class SetterNode extends DefinitionMemberNode {
	...
	public SetterNode(CodePosition position, List<AnnotationNode> annotations, ModifiersNode modifiers, NameNode name, TypeNode type, ASTNode body) {
