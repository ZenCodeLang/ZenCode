...
public enum BuiltinMethodSymbol implements MethodSymbol {
	...
	BOOL_TO_STRING(BOOL, MethodID.caster(STRING), STRING),
	...
	BYTE_TO_SBYTE(BYTE, MethodID.caster(SBYTE), SBYTE),
	BYTE_TO_SHORT(BYTE, MethodID.caster(SHORT), SHORT),
	BYTE_TO_USHORT(BYTE, MethodID.caster(USHORT), USHORT),
	BYTE_TO_INT(BYTE, MethodID.caster(INT), INT),
	BYTE_TO_UINT(BYTE, MethodID.caster(UINT), UINT),
	BYTE_TO_LONG(BYTE, MethodID.caster(LONG), LONG),
	BYTE_TO_ULONG(BYTE, MethodID.caster(ULONG), ULONG),
	BYTE_TO_USIZE(BYTE, MethodID.caster(USIZE), USIZE),
	BYTE_TO_FLOAT(BYTE, MethodID.caster(FLOAT), FLOAT),
	BYTE_TO_DOUBLE(BYTE, MethodID.caster(DOUBLE), DOUBLE),
	BYTE_TO_CHAR(BYTE, MethodID.caster(CHAR), CHAR),
	BYTE_TO_STRING(BYTE, MethodID.caster(STRING), STRING),
	...
	SBYTE_TO_BYTE(SBYTE, MethodID.caster(BYTE), BYTE),
	SBYTE_TO_SHORT(SBYTE, MethodID.caster(SHORT), SHORT),
	SBYTE_TO_USHORT(SBYTE, MethodID.caster(USHORT), USHORT),
	SBYTE_TO_INT(SBYTE, MethodID.caster(INT), INT),
	SBYTE_TO_UINT(SBYTE, MethodID.caster(UINT), UINT),
	SBYTE_TO_LONG(SBYTE, MethodID.caster(LONG), LONG),
	SBYTE_TO_ULONG(SBYTE, MethodID.caster(ULONG), ULONG),
	SBYTE_TO_USIZE(SBYTE, MethodID.caster(USIZE), USIZE),
	SBYTE_TO_FLOAT(SBYTE, MethodID.caster(FLOAT), FLOAT),
	SBYTE_TO_DOUBLE(SBYTE, MethodID.caster(DOUBLE), DOUBLE),
	SBYTE_TO_CHAR(SBYTE, MethodID.caster(CHAR), CHAR),
	SBYTE_TO_STRING(SBYTE, MethodID.caster(STRING), STRING),
	...
	SHORT_TO_BYTE(SHORT, MethodID.caster(BYTE), BYTE),
	SHORT_TO_SBYTE(SHORT, MethodID.caster(SBYTE), SBYTE),
	SHORT_TO_USHORT(SHORT, MethodID.caster(USHORT), USHORT),
	SHORT_TO_INT(SHORT, MethodID.caster(INT), INT),
	SHORT_TO_UINT(SHORT, MethodID.caster(UINT), UINT),
	SHORT_TO_LONG(SHORT, MethodID.caster(LONG), LONG),
	SHORT_TO_ULONG(SHORT, MethodID.caster(ULONG), ULONG),
	SHORT_TO_USIZE(SHORT, MethodID.caster(USIZE), USIZE),
	SHORT_TO_FLOAT(SHORT, MethodID.caster(FLOAT), FLOAT),
	SHORT_TO_DOUBLE(SHORT, MethodID.caster(DOUBLE), DOUBLE),
	SHORT_TO_CHAR(SHORT, MethodID.caster(CHAR), CHAR),
	SHORT_TO_STRING(SHORT, MethodID.caster(STRING), STRING),
	...
	USHORT_TO_BYTE(USHORT, MethodID.caster(BYTE), BYTE),
	USHORT_TO_SBYTE(USHORT, MethodID.caster(SBYTE), SBYTE),
	USHORT_TO_SHORT(USHORT, MethodID.caster(SHORT), SHORT),
	USHORT_TO_INT(USHORT, MethodID.caster(INT), INT),
	USHORT_TO_UINT(USHORT, MethodID.caster(UINT), UINT),
	USHORT_TO_LONG(USHORT, MethodID.caster(LONG), LONG),
	USHORT_TO_ULONG(USHORT, MethodID.caster(ULONG), ULONG),
	USHORT_TO_USIZE(USHORT, MethodID.caster(USIZE), USIZE),
	USHORT_TO_FLOAT(USHORT, MethodID.caster(FLOAT), FLOAT),
	USHORT_TO_DOUBLE(USHORT, MethodID.caster(DOUBLE), DOUBLE),
	USHORT_TO_CHAR(USHORT, MethodID.caster(CHAR), CHAR),
	USHORT_TO_STRING(USHORT, MethodID.caster(STRING), STRING),
	...
	INT_TO_BYTE(INT, MethodID.caster(BYTE), BYTE),
	INT_TO_SBYTE(INT, MethodID.caster(SBYTE), SBYTE),
	INT_TO_SHORT(INT, MethodID.caster(SHORT), SHORT),
	INT_TO_USHORT(INT, MethodID.caster(USHORT), USHORT),
	INT_TO_UINT(INT, MethodID.caster(UINT), UINT),
	INT_TO_LONG(INT, MethodID.caster(LONG), LONG),
	INT_TO_ULONG(INT, MethodID.caster(ULONG), ULONG),
	INT_TO_USIZE(INT, MethodID.caster(USIZE), USIZE),
	INT_TO_FLOAT(INT, MethodID.caster(FLOAT), FLOAT),
	INT_TO_DOUBLE(INT, MethodID.caster(DOUBLE), DOUBLE),
	INT_TO_CHAR(INT, MethodID.caster(CHAR), CHAR),
	INT_TO_STRING(INT, MethodID.caster(STRING), STRING),
	...
	UINT_TO_BYTE(UINT, MethodID.caster(BYTE), BYTE),
	UINT_TO_SBYTE(UINT, MethodID.caster(SBYTE), SBYTE),
	UINT_TO_SHORT(UINT, MethodID.caster(SHORT), SHORT),
	UINT_TO_USHORT(UINT, MethodID.caster(USHORT), USHORT),
	UINT_TO_INT(UINT, MethodID.caster(INT), INT),
	UINT_TO_LONG(UINT, MethodID.caster(LONG), LONG),
	UINT_TO_ULONG(UINT, MethodID.caster(ULONG), ULONG),
	UINT_TO_USIZE(UINT, MethodID.caster(USIZE), USIZE),
	UINT_TO_FLOAT(UINT, MethodID.caster(FLOAT), FLOAT),
	UINT_TO_DOUBLE(UINT, MethodID.caster(DOUBLE), DOUBLE),
	UINT_TO_CHAR(UINT, MethodID.caster(CHAR), CHAR),
	UINT_TO_STRING(UINT, MethodID.caster(STRING), STRING),
	...
	LONG_TO_BYTE(LONG, MethodID.caster(BYTE), BYTE),
	LONG_TO_SBYTE(LONG, MethodID.caster(SBYTE), SBYTE),
	LONG_TO_SHORT(LONG, MethodID.caster(SHORT), SHORT),
	LONG_TO_USHORT(LONG, MethodID.caster(USHORT), USHORT),
	LONG_TO_INT(LONG, MethodID.caster(INT), INT),
	LONG_TO_UINT(LONG, MethodID.caster(UINT), UINT),
	LONG_TO_ULONG(LONG, MethodID.caster(ULONG), ULONG),
	LONG_TO_USIZE(LONG, MethodID.caster(USIZE), USIZE),
	LONG_TO_FLOAT(LONG, MethodID.caster(FLOAT), FLOAT),
	LONG_TO_DOUBLE(LONG, MethodID.caster(DOUBLE), DOUBLE),
	LONG_TO_CHAR(LONG, MethodID.caster(CHAR), CHAR),
	LONG_TO_STRING(LONG, MethodID.caster(STRING), STRING),
	...
	ULONG_TO_BYTE(ULONG, MethodID.caster(BYTE), BYTE),
	ULONG_TO_SBYTE(ULONG, MethodID.caster(SBYTE), SBYTE),
	ULONG_TO_SHORT(ULONG, MethodID.caster(SHORT), SHORT),
	ULONG_TO_USHORT(ULONG, MethodID.caster(USHORT), USHORT),
	ULONG_TO_INT(ULONG, MethodID.caster(INT), INT),
	ULONG_TO_UINT(ULONG, MethodID.caster(UINT), UINT),
	ULONG_TO_LONG(ULONG, MethodID.caster(LONG), LONG),
	ULONG_TO_USIZE(ULONG, MethodID.caster(USIZE), USIZE),
	ULONG_TO_FLOAT(ULONG, MethodID.caster(FLOAT), FLOAT),
	ULONG_TO_DOUBLE(ULONG, MethodID.caster(DOUBLE), DOUBLE),
	ULONG_TO_CHAR(ULONG, MethodID.caster(CHAR), CHAR),
	ULONG_TO_STRING(ULONG, MethodID.caster(STRING), STRING),
	...
	USIZE_TO_BYTE(USIZE, MethodID.caster(BYTE), BYTE),
	USIZE_TO_SBYTE(USIZE, MethodID.caster(SBYTE), SBYTE),
	USIZE_TO_SHORT(USIZE, MethodID.caster(SHORT), SHORT),
	USIZE_TO_USHORT(USIZE, MethodID.caster(USHORT), USHORT),
	USIZE_TO_INT(USIZE, MethodID.caster(INT), INT),
	USIZE_TO_UINT(USIZE, MethodID.caster(UINT), UINT),
	USIZE_TO_LONG(USIZE, MethodID.caster(LONG), LONG),
	USIZE_TO_ULONG(USIZE, MethodID.caster(ULONG), ULONG),
	USIZE_TO_FLOAT(USIZE, MethodID.caster(FLOAT), FLOAT),
	USIZE_TO_DOUBLE(USIZE, MethodID.caster(DOUBLE), DOUBLE),
	USIZE_TO_CHAR(USIZE, MethodID.caster(CHAR), CHAR),
	USIZE_TO_STRING(USIZE, MethodID.caster(STRING), STRING),
	...
	FLOAT_TO_BYTE(FLOAT, MethodID.caster(BYTE), BYTE),
	FLOAT_TO_SBYTE(FLOAT, MethodID.caster(SBYTE), SBYTE),
	FLOAT_TO_SHORT(FLOAT, MethodID.caster(SHORT), SHORT),
	FLOAT_TO_USHORT(FLOAT, MethodID.caster(USHORT), USHORT),
	FLOAT_TO_INT(FLOAT, MethodID.caster(INT), INT),
	FLOAT_TO_UINT(FLOAT, MethodID.caster(UINT), UINT),
	FLOAT_TO_LONG(FLOAT, MethodID.caster(LONG), LONG),
	FLOAT_TO_ULONG(FLOAT, MethodID.caster(ULONG), ULONG),
	FLOAT_TO_USIZE(FLOAT, MethodID.caster(USIZE), USIZE),
	FLOAT_TO_DOUBLE(FLOAT, MethodID.caster(DOUBLE), DOUBLE),
	FLOAT_TO_STRING(FLOAT, MethodID.caster(STRING), STRING),
	...
	DOUBLE_TO_BYTE(DOUBLE, MethodID.caster(BYTE), BYTE),
	DOUBLE_TO_SBYTE(DOUBLE, MethodID.caster(SBYTE), SBYTE),
	DOUBLE_TO_SHORT(DOUBLE, MethodID.caster(SHORT), SHORT),
	DOUBLE_TO_USHORT(DOUBLE, MethodID.caster(USHORT), USHORT),
	DOUBLE_TO_INT(DOUBLE, MethodID.caster(INT), INT),
	DOUBLE_TO_UINT(DOUBLE, MethodID.caster(UINT), UINT),
	DOUBLE_TO_LONG(DOUBLE, MethodID.caster(LONG), LONG),
	DOUBLE_TO_ULONG(DOUBLE, MethodID.caster(ULONG), ULONG),
	DOUBLE_TO_USIZE(DOUBLE, MethodID.caster(USIZE), USIZE),
	DOUBLE_TO_FLOAT(DOUBLE, MethodID.caster(FLOAT), FLOAT),
	DOUBLE_TO_STRING(DOUBLE, MethodID.caster(STRING), STRING),
	...
	CHAR_TO_BYTE(CHAR, MethodID.caster(BYTE), BYTE),
	CHAR_TO_SBYTE(CHAR, MethodID.caster(SBYTE), SBYTE),
	CHAR_TO_SHORT(CHAR, MethodID.caster(SHORT), SHORT),
	CHAR_TO_USHORT(CHAR, MethodID.caster(USHORT), USHORT),
	CHAR_TO_INT(CHAR, MethodID.caster(INT), INT),
	CHAR_TO_UINT(CHAR, MethodID.caster(UINT), UINT),
	CHAR_TO_LONG(CHAR, MethodID.caster(LONG), LONG),
	CHAR_TO_ULONG(CHAR, MethodID.caster(ULONG), ULONG),
	CHAR_TO_USIZE(CHAR, MethodID.caster(USIZE), USIZE),
	CHAR_TO_STRING(CHAR, MethodID.caster(STRING), STRING),
