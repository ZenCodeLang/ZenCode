...
public class TypeArgumentsNode implements ASTNode {
	private final CodePosition position;
	private final List<TypeNode> types;

	public TypeArgumentsNode(CodePosition position, List<TypeNode> types) {
	...
	public <C, R> R accept(ASTVisitor<C, R> visitor, C context) {
		return visitor.visitTypeArguments(this, context);
	}
