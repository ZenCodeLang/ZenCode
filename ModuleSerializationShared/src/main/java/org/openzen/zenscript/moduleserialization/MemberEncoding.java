...
public class MemberEncoding {
	...
	public static final int TYPE_GETTER = 4;
	public static final int TYPE_SETTER = 5;
	public static final int TYPE_OPERATOR = 6;
	public static final int TYPE_CASTER = 7;
	public static final int TYPE_ITERATOR = 8;
	public static final int TYPE_IMPLEMENTATION = 9;
	public static final int TYPE_INNER_DEFINITION = 10;
	public static final int TYPE_STATIC_INITIALIZER = 11;
