...
public class MemberSerializer implements MemberVisitorWithContext<TypeContext, Void> {
	...
	private int getId(OperatorType operator) {
		switch (operator) {
			case ADD: return MemberEncoding.OPERATOR_ADD;
			case SUB: return MemberEncoding.OPERATOR_SUB;
			case MUL: return MemberEncoding.OPERATOR_MUL;
			case DIV: return MemberEncoding.OPERATOR_DIV;
			case MOD: return MemberEncoding.OPERATOR_MOD;
			case CAT: return MemberEncoding.OPERATOR_CAT;
			case OR: return MemberEncoding.OPERATOR_OR;
			case AND: return MemberEncoding.OPERATOR_AND;
			case XOR: return MemberEncoding.OPERATOR_XOR;
			case NEG: return MemberEncoding.OPERATOR_NEG;
			case INVERT: return MemberEncoding.OPERATOR_INVERT;
			case NOT: return MemberEncoding.OPERATOR_NOT;
			case INDEXSET: return MemberEncoding.OPERATOR_INDEXSET;
			case INDEXGET: return MemberEncoding.OPERATOR_INDEXGET;
			case CONTAINS: return MemberEncoding.OPERATOR_CONTAINS;
			case COMPARE: return MemberEncoding.OPERATOR_COMPARE;
			case MEMBERGETTER: return MemberEncoding.OPERATOR_MEMBERGETTER;
			case MEMBERSETTER: return MemberEncoding.OPERATOR_MEMBERSETTER;
			case EQUALS: return MemberEncoding.OPERATOR_EQUALS;
			case NOTEQUALS: return MemberEncoding.OPERATOR_NOTEQUALS;
			case SAME: return MemberEncoding.OPERATOR_SAME;
			case NOTSAME: return MemberEncoding.OPERATOR_NOTSAME;
			case SHL: return MemberEncoding.OPERATOR_SHL;
			case SHR: return MemberEncoding.OPERATOR_SHR;
			case USHR: return MemberEncoding.OPERATOR_USHR;
			case ADDASSIGN: return MemberEncoding.OPERATOR_ADDASSIGN;
			case SUBASSIGN: return MemberEncoding.OPERATOR_SUBASSIGN;
			case MULASSIGN: return MemberEncoding.OPERATOR_MULASSIGN;
			case DIVASSIGN: return MemberEncoding.OPERATOR_DIVASSIGN;
			case MODASSIGN: return MemberEncoding.OPERATOR_MODASSIGN;
			case CATASSIGN: return MemberEncoding.OPERATOR_CATASSIGN;
			case ORASSIGN: return MemberEncoding.OPERATOR_ORASSIGN;
			case XORASSIGN: return MemberEncoding.OPERATOR_XORASSIGN;
			case SHLASSIGN: return MemberEncoding.OPERATOR_SHLASSIGN;
			case SHRASSIGN: return MemberEncoding.OPERATOR_SHRASSIGN;
			case USHRASSIGN: return MemberEncoding.OPERATOR_USHRASSIGN;
			case INCREMENT: return MemberEncoding.OPERATOR_INCREMENT;
			case DECREMENT: return MemberEncoding.OPERATOR_DECREMENT;
			case RANGE: return MemberEncoding.OPERATOR_RANGE;
