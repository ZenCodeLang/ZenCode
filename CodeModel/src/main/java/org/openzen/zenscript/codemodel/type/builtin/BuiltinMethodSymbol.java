...
public enum BuiltinMethodSymbol implements MethodSymbol {
	...
	STRING_DOLLAR(STRING, MethodID.getter("$"), USIZE),
	...
	ARRAY_DOLLAR1D(ArrayTypeSymbol.ARRAY, MethodID.getter("$"), USIZE),
